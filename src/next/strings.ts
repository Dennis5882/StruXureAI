...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  qFreeHint:    { ko: '미연결 = 근처(600mm 내)에 붙을 상대가 있는데 안 붙은 벽/보 끝. 이것만 검토하면 됩니다.', en: 'Unresolved = wall/beam ends with a neighbor within 600mm but not connected. Only these need review.', zh: '未連接＝600mm 內有可接構件卻未接的牆/梁端點。只需檢視這些。' },
  qAtColumn:    { ko: '기둥에 연결', en: 'At column', zh: '接於柱' },
  qAtColumnHint:{ ko: '벽/보 끝이 기둥 절점에 붙어 있습니다. 정상입니다.', en: 'Wall/beam ends sitting on a column node. This is fine.', zh: '牆/梁端點位於柱節點上，屬正常。' },
  qOpenEnd:     { ko: '개방 단부', en: 'Open ends', zh: '開放端' },
  qOpenEndHint: { ko: '주변에 붙을 상대가 없는 끝(개구부·건물 외곽). 정상입니다.', en: 'Ends with nothing nearby to connect to (openings, building edge). This is fine.', zh: '周圍無可接構件的端點（開口、建物外緣），屬正常。' },
