...
> 기준 버전: **v0.24.0** · 갱신: 2026-06-24 · 배포: Vercel (`stru-xure-ai.vercel.app`)
...
6. **남은 벽 품질**(북극성 직결):
   - **단일선 벽**: B1F CON_WALL 중 진짜 짝없는 면 ~16개(긴 것 5개, 26m). 기본두께 부여 vs 보류 — 보수적으로.
   - **연결성**: 자유단 ~58개(노드 68). 토막 끝점을 인접 벽/콜리니어 끝에 연결(현재 cleanupTopology는 기둥/교차점만). 개구부 단부는 정상 자유단이라 구분 필요.
   - 목표: 커버리지 89%→95%+, 자유단↓.
